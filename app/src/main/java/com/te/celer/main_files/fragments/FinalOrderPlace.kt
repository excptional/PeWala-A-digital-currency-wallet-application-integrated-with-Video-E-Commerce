...
import com.te.celer.main_files.RazorpayPayment
import com.te.celer.main_files.adapters.OrderSummaryAdapter
...
//        if (orderSummaryItemsArray.isEmpty()) {
...
//                    Navigation.findNavController(requireView()).navigate(R.id.nav_razorpay_payment, bundle)
                    ...
                    val intent = Intent(requireContext(), RazorpayPayment::class.java).apply {
                        putExtras(bundle)
                    }
